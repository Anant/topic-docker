...
var config = {
  ...
  site_title: ' CIO/CTO Training : Docker',

  // The base URL of your site (can use %base_url% in Markdown files)
  base_url: '',

  // Used for the "Get in touch" page footer link
  support_email: 'rahul.singh@anant.us',

  // Footer Text / Copyright
  copyright: 'Copyright &copy; '+ new Date().getFullYear() +' - <a href="http://anant.us">A project of Anant Labs</a>',
